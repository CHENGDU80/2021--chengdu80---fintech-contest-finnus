# new page for new business risk score
# Dash packages
...
card_tabs=dbc.Card(
    [
        ...
        dbc.CardBody(html.P(id="card-content1", className="card-text")),
...
risk_scores = dbc.Card(
    dbc.CardBody(
        [
            dbc.Row([html.H4(["Legal risks", dbc.Badge(
                "Low", color="success", className="ml-1",style={'margin-right': '30px'})]),
            html.H4(["Operation risks", dbc.Badge(
                "Low",  color="success", className="ml-1",style={'margin-right': '30px'})]),
            html.H4(["Loan risks", dbc.Badge(
                "Low",  color="success", className="ml-1",style={'margin-right': '30px'})]),
            html.H4(["Other risks", dbc.Badge(
                "Medium",  color="warning", className="ml-1",style={'margin-right': '30px'})])],justify='between'
                ),
            dbc.Badge("✓ Verified data secured on distributed ledger", color='light',style={'textAlign': 'left'})],
        style={'textAlign': 'left','margin-left':'20px'}
    ),style={'margin-left':'7%','width':'1200px'}
)
...
layout=dbc.Container(
                        ...
                        dbc.Col([dbc.Row([html.H4("Entity ID",style={'margin-left':'10%'}),
                                dbc.Badge("5721945299", pill=True,style={"fontSize": "20px", "margin-left": "13%"})]),
                                html.P(),
                                dbc.Row([html.H4("Company Name",style={'margin-left':'10%'}),
                                dbc.Badge("Chengdu Inc.", pill=True,style={"fontSize": "20px", "margin-left": "6%",'margin-right':'5%'}),
                                ]),
                                html.P(),
                                dbc.Col(risk_scores)
                                ]),
...
@app.callback(
    Output("example-output1", "children"), [
        Input("add-to-watchlist-button1", "n_clicks")]
)
